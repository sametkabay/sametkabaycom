...
namespace SametKabay.Application.Helpers
{
    public class PasswordHelper
    {
        ...
        public static string ChangePassword(string oldPassword, string oldHashedPassword, string oldSalt, string newPassword)
        {
            string old = 1000 + ":" + oldSalt + ":" + oldHashedPassword;
