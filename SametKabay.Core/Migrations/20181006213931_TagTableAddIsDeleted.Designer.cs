...
namespace SametKabay.Core.Migrations
{
    ...
    [Migration("20181006213931_TagTableAddIsDeleted")]
    partial class TagTableAddIsDeleted
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SametKabay.Core.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SametKabay.Core.Models.BlogCategoryTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SametKabay.Core.Models.User", b =>
                {
                    ...
                    b.Property<int?>("ActivatingUserId");
            ...
            modelBuilder.Entity("SametKabay.Core.Models.BlogCategoryTag", b =>
                {
                    b.HasOne("SametKabay.Core.Models.BlogCategory")
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("SametKabay.Core.Models.BlogComment", b =>
                {
                    b.HasOne("SametKabay.Core.BlogPost")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SametKabay.Core.Models.BlogPostCategory", b =>
                {
                    ...
                    b.HasOne("SametKabay.Core.BlogPost", "Post")
                        .WithMany("PostCategory")
            ...
            modelBuilder.Entity("SametKabay.Core.Models.User", b =>
                {
                    b.HasOne("SametKabay.Core.Models.User", "ActivatingUser")
                        .WithMany("ActivatingUsers")
                        .HasForeignKey("ActivatingUserId");
                });
